...
# Description    : To install/configure a K8s cluster on a single Ubuntu or RHEL node.
...
This script will install a multi-node K8s cluster on an Ubuntu or RHEL node through kubeadm. You must meet the
